...
export const useCases: UseCase[] = [
  ...
  },
  {
    ...
    template: {
      ...
      decoImage: '/use-cases/template-deco.webp',
      title: '전력관리 템플릿으로 시작',
      desc: '전력을 처음 들여다보는 현장이라면 무엇부터 재고 어떻게 봐야 할지 막막합니다. 여러 현장을 거치며 정리해 둔 템플릿에는 설비별 계량을 어떻게 잡고<br>피크와 역률을 어떤 기준으로 볼지가 담겨 있습니다. 설비 목록과 계약 조건만 맞춰 넣으면 구조를 처음부터 짤 필요 없이 바로 시작할 수 있습니다.',
