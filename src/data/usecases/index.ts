...
export const useCases: UseCase[] = [
  {
    ...
    flow: {
      title: '부착부터 조치까지, 네 단계',
      subtitle: '배선 공사도 서버 준비도 없이 시작해, 판정과 조치까지 한 흐름으로 이어집니다.',
      steps: [
        { label: '부착', detail: '모터 하우징에 WISE-2410을 붙입니다. 배선도 정지도 필요 없어 돌아가는 설비에 그대로 답니다.' },
        { label: '수집', detail: 'WISE-6610 게이트웨이가 LoRaWAN으로 3축 진동과 온도를 모읍니다. 최대 5km까지 닿습니다.' },
        { label: '판정', detail: 'ISO-20816 기준으로 지금 상태가 정상인지 주의인지 위험인지 가릅니다.' },
        { label: '조치', detail: '추세에서 전조가 보이면 원인 추정과 다음 조치를 근거와 함께 알립니다.' },
      ],
      note: '기존 설비 교체나 라인 정지 없이 한 대부터 시작해, 효과를 확인한 뒤 대수를 늘려갈 수 있습니다.',
    },
