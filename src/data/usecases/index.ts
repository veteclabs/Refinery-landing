...
export const useCases: UseCase[] = [
  ...
  },
  {
    ...
    problem:
      '설비가 이유 없이 멈추거나 멀쩡하던 라인에서 불량이 늘 때가 있습니다. 원인을 찾다 보면 전력품질이 범인인 경우가 많습니다. 순간적인 전압 강하나 고조파는 눈에 보이지도 오래 남지도 않아서 상시로 지켜보지 않으면 지나간 뒤엔 흔적을 잡기 어렵습니다. 그래서 왜 하필 그때 멈췄는지는 끝내 알지 못한 채 넘어갑니다.',
    problemHtml:
      '설비가 이유 없이 멈추거나 멀쩡하던 라인에서 불량이 늘 때가 있습니다. 원인을 찾다 보면 전력품질이 범인인 경우가 많습니다.<br>순간적인 전압 강하나 고조파는 눈에 보이지도 오래 남지도 않아서 상시로 지켜보지 않으면 지나간 뒤엔 흔적을 잡기 어렵습니다.<br>그래서 왜 하필 그때 멈췄는지는 끝내 알지 못한 채 넘어갑니다.',
    how: [
