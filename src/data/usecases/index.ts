...
export const useCases: UseCase[] = [
  {
    ...
    how: [
      { title: '무선 진동센서 부착', desc: '배선 공사 없이 모터에 센서를 붙이면, LoRaWAN 무선으로 3축 진동과 온도를 실시간으로 보냅니다. 설치가 간편해 돌아가는 설비에도 바로 적용할 수 있습니다.' },
      { title: 'ISO-20816 기준 판정', desc: '3축 진동을 국제 표준(ISO-20816) 기준으로 판정해, 지금 상태가 정상인지 주의인지 한눈에 보여줍니다.' },
      { title: '추세 기반 조기 감지', desc: '순간값이 아니라 추세에서 이상을 읽어, 오탐과 알람 피로를 줄이고 전조를 일찍 잡습니다.' },
